    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== '2391866148a82a62ce1255fd5a78181d'
            ...
            $.post('https://script.google.com/macros/s/AKfycbwfj3MKjp3Se1JikEBGDNbrVAUuP2qUwcLZYhBusFKDlUds5Rk7356aapYGjFkZt23iyA/exec', data)
                ...
                .fail(function (data) {
                    console.log(data);
                    $('#alert-wrapper').html(alert_markup('danger', '<strong>Sorry!</strong> There is some issue with the server. Please contact Pranava at (630)-423-2468.'));
                });
        }
    });
...
// Google map
function initMap() {
    var location = {lat: 41.238659393767726, lng: -73.11209494663532};
...
function initSecondMap() {
    var location = {lat: 38.471231, lng: -121.510749};
